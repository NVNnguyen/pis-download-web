              ...
              <CardContent>
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                  ...
                  <div className="flex gap-2">
                    <DownloadButton className="bg-white text-black hover:bg-gray-200">
                      Download APK
                    </DownloadButton>
                    <Link
            ...
            <div className="space-y-6">
              <div>
                ...
                <ol className="list-decimal list-inside space-y-2 text-gray-300">
                  ...
                  <li>
                    If prompted, enable "Install from Unknown Sources" in your
                    device settings
                  </li>
                  <li>
                    ...
                    <div className="flex flex-col md:flex-row gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-gray-400">
                          Browse posts from friends and public content in our
                          clean, distraction-free interface.
                        </p>
                        <ul className="list-disc list-inside mt-2 text-gray-300 text-sm">
                          <li>
                            Toggle between public and friends-only content
                          </li>
                  ...
                  <CardContent className="p-4">
                    <div className="flex flex-col md:flex-row gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-gray-400">
                          Record and share audio clips with your network.
                        </p>
                        <ul className="list-disc list-inside mt-2 text-gray-300 text-sm">
          ...
          <div>
            <div className="sticky top-8">
              <Card className="bg-gray-900 border-gray-800 mb-6">
                <CardContent className="pt-6">
                  <div className="flex flex-col items-center text-center gap-4">
                    ...
                    <p className="text-gray-400">
                      Connect with friends in a minimalist black and white
                      interface.
                    </p>
              ...
              <div className="grid grid-cols-2 gap-4">
                <Button
                  variant="outline"
                  className="border-gray-800 hover:bg-gray-800 flex-col h-auto py-4"
                >
